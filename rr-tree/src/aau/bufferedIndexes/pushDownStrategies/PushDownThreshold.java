...
/**
 * A push down strategy that applies a global threshold.  For GroupUpdate restarts re-applies the threshold.
 */
public class PushDownThreshold<E extends Convertable> extends AbstractPushDownThreshold<E> {

    /**
     * Creates a new strategy object with the specified threshold
     ...
     */
    public PushDownThreshold(final int threshold, final boolean groupSizeByInsertions) {
    ...
    /**
     * Tells if this strategy is likely to empty significant part of the buffer.  Global thresholding is likely to
     * empty large part of the buffer.
     *
