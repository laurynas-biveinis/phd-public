 ...
 * parameter of the invokation method is taken as the identifier of the
 ...
 * 
 * @param <I> the type of the identifiers used for identifing the different
 *        cases.
 * @param <R> the result type of the switch function, i.e., a supertype for all
 *        given functions modelling the cases of the switch function.
 */
public class Switch<I, R> extends Function<Object, R> {
	 ...
	 * @return the function that previously dealed with the case the specified
	 ...
	 * @return the function that previously dealed with the default case.
	 */
     ...
     * specified by the map's {@link Map#keySet() keySet} method.
     * 
     * @return an iteration conatining the identifiers associated with the
     *         cases of this switch function.
     */
     ...
     * specified by the map's {@link Map#keySet() keySet} method.
     * 
     * @return an iteration conatining the functions dealing with the cases of
     *         this switch function.
     */
	public Cursor<Function<Object, ? extends R>> functions() {
		return new Mapper<I, Function<Object, ? extends R>>(
			new Function<I, Function<Object, ? extends R>>() {
	 ...
	 */
	@SuppressWarnings("unchecked") // the first argument mut be the identifier
	public R invoke(List<? extends Object> arguments) throws IllegalArgumentException {
		if (arguments.size() == 0)
