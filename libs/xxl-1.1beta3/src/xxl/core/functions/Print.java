 ...
 * If an array of arguments is given the single objects will be separated by a
 * given delimiter. Print-Functions can be used to log a composition of
 * functions at a specified level. To do so just a Prin-Function has to be
 * inserted at the right place like
 * <code><pre>
 *   Function&lt;Number, Double&gt; tan = div.compose(new Print&lt;Double&gt;().compose(sin), cos);
 * </pre></code>
 * instead of 
 * <code><pre>
 ...
 */
public class Print<T> extends Function<T, T> {

	/**
	 * Default Function for Print using System.out as
	 * {@link java.io.PrintStream PrintStream} and space as delimeter.
	 */
	public static final Print<Object> DEFAULT_INSTANCE = new Print<Object>();
	 ...
	 *        for the output.
	 * @param delimiter delimeter used for separating array-arguments.
	 */
	public Print(PrintStream printStream, String delimiter) {
	...
	public static void main(String[] args) {
		...
		Function<Number, Double> tan = div.compose(print.compose(sin), cos);
