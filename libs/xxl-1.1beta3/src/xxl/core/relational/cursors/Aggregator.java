...
public class Aggregator extends xxl.core.cursors.mappers.Aggregator<Tuple, Tuple> implements MetaDataCursor<Tuple, CompositeMetaData<Object, Object>> {
	 ...
	 * its precision is 52.
	 */
	public static final MetaDataAggregationFunction<Number, Number, CompositeMetaData<Object, Object>> AVG = new MetaDataAggregationFunction<Number, Number, CompositeMetaData<Object, Object>>(new Average()) {
		protected CompositeMetaData<Object, Object> globalMetaData = new CompositeMetaData<Object, Object>();
		{
	 ...
	 */
	public static final MetaDataAggregationFunction<Number, Number, CompositeMetaData<Object, Object>> STDDEV = new MetaDataAggregationFunction<Number, Number, CompositeMetaData<Object, Object>>(new StandardDeviation()) {
		protected CompositeMetaData<Object, Object> globalMetaData = new CompositeMetaData<Object, Object>();
		{
	 ...
	 * its precision is 52.
	 */
	public static final MetaDataAggregationFunction<Number, Number, CompositeMetaData<Object, Object>> Variance = new MetaDataAggregationFunction<Number, Number, CompositeMetaData<Object, Object>>(new Variance()) {
		protected CompositeMetaData<Object, Object> globalMetaData = new CompositeMetaData<Object, Object>();
 		{
	...
	protected static MetaDataAggregationFunction<Tuple, Object, CompositeMetaData<Object, Object>>[] getTupleAggregationFunctions(MetaDataAggregationFunction<Object, Object, CompositeMetaData<Object, Object>>[] aggregates, int[] aggregatedColumns) {
		...
		for (int i = 0; i < aggregates.length; i++)
			composedAggregates[i] = new MetaDataAggregationFunction<Tuple, Object, CompositeMetaData<Object, Object>>(
				aggregates[i].compose(
					Tuples.getObjectFunction(i)
				)
			) {
				public CompositeMetaData<Object, Object> getMetaData() {
					return ((MetaDataProvider<CompositeMetaData<Object, Object>>)aggregationFunction).getMetaData();
				}
			};
	 ...
	 * @param aggregates an array of metadata aggreagtes that each computes an
