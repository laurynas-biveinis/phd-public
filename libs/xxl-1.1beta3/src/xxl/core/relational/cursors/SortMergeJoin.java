 ...
 * in a sweep-area. So, thepredicate and the comparator have to be chosen
 * carefully!</p>
 * 
...
public class SortMergeJoin extends xxl.core.cursors.joins.SortMergeJoin<Tuple, Tuple> implements MetaDataCursor<Tuple, CompositeMetaData<Object, Object>> {
	 ...
	 *        elements of the enumeration defined above in this class.
	 */
	public SortMergeJoin(MetaDataCursor<? extends Tuple, CompositeMetaData<Object, Object>> sortedCursor1, MetaDataCursor<? extends Tuple, CompositeMetaData<Object, Object>> sortedCursor2, MergedResultSetMetaData metaData, SweepArea<Tuple> sweepArea1, SweepArea<Tuple> sweepArea2, Comparator<? super Tuple> comparator, Function<Object, ? extends Tuple> createTuple, Type type) {
		super(
			sortedCursor1,
			sortedCursor2,
			sweepArea1,
	 ...
	 *        elements of the enumeration defined above in this class.
	 */
	public SortMergeJoin(MetaDataCursor<? extends Tuple, CompositeMetaData<Object, Object>> sortedCursor1, MetaDataCursor<? extends Tuple, CompositeMetaData<Object, Object>> sortedCursor2, MetaDataPredicate<? super Tuple, CompositeMetaData<Object, Object>> theta, SweepArea<Tuple> sweepArea1, SweepArea<Tuple> sweepArea2, Comparator<? super Tuple> comparator, Function<Object, ? extends Tuple> createTuple, Type type) {
		this(
			sortedCursor1,
			sortedCursor2,
	 ...
	 *        elements of the enumeration defined above in this class.
	 */
	public SortMergeJoin(MetaDataCursor<? extends Tuple, CompositeMetaData<Object, Object>> sortedCursor1, MetaDataCursor<? extends Tuple, CompositeMetaData<Object, Object>> sortedCursor2, SweepArea<Tuple> sweepArea1, SweepArea<Tuple> sweepArea2, Comparator<? super Tuple> comparator, Function<Object, ? extends Tuple> createTuple, Type type) {
		this(
			sortedCursor1,
			sortedCursor2,
	 ...
	 *        elements of the enumeration defined above in this class.
	 */
	public SortMergeJoin(ResultSet sortedResultSet1, ResultSet sortedResultSet2, MetaDataPredicate<? super Tuple, CompositeMetaData<Object, Object>> theta, SweepArea<Tuple> sweepArea1, SweepArea<Tuple> sweepArea2, Comparator<? super Tuple> comparator, Function<Object, ? extends Tuple> createTuple, Type type) {
		this(
	 ...
	 *        elements of the enumeration defined above in this class.
	 */
	public SortMergeJoin(ResultSet sortedResultSet1, ResultSet sortedResultSet2, SweepArea<Tuple> sweepArea1, SweepArea<Tuple> sweepArea2, Comparator<? super Tuple> comparator, Function<Object, ? extends Tuple> createTuple, Type type) {
		this(
			new ResultSetMetaDataCursor(sortedResultSet1),
			new ResultSetMetaDataCursor(sortedResultSet2),
			sweepArea1,
