...
public class Orenstein extends SortMergeJoin {
	 ...
	 */
	public static MetaDataFunction<Tuple, ArrayTuple, CompositeMetaData<Object, Object>> FLOAT_VALUE_TUPLE_TO_FLOAT_POINT_TUPLE = new MetaDataFunction<Tuple, ArrayTuple, CompositeMetaData<Object, Object>>(
		new Function<Tuple, ArrayTuple> () {
	 ...
	 * @param epsilon epsilon-distance.
	 * @param maxLevel maximum level of the partitioning.
	 * @param type the join type (see {@link Type}).
	 */
	private Orenstein(
	 ...
	 * @param epsilon epsilon-distance.
	 * @param maxLevel maximum level of the partitioning.
	 * @param type the join type (see {@link Type}). Here, only the types
