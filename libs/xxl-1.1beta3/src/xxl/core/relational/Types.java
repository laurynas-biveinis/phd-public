...
public final class Types {
	...
	static {
		...
		putTypeMapping(sqlTypeMap, java.sql.Types.DATE,          "DATA",          DATE);
	...
	public static boolean areComparable(int type1, int type2) {
		switch (type1) {
			...
			case FLOAT:
			case BIG_DECIMAL:
				return type2 == BYTE || type2 == SHORT || type2 == INTEGER || type2 == LONG || type2 == BIG_DECIMAL || type2 == FLOAT || type2 == DOUBLE;
			case CHARACTER:
			case STRING:
