...
public  class XMLResultSetMetaData implements java.sql.ResultSetMetaData 
{
	...
	public String getColumnClassName(int column) {		
		...
		return (converterMap.getJavaClassName((String) typeList.get(column)));
	}
	...
	public int getColumnType(int column) {
		...
		return (converterMap.getSQLType((String) typeList.get(column)));
	}
	...
	public String getColumnTypeName(int column) {
		...
		return (String) typeList.get(column);
	}
