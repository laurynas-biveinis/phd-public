 ...
 */
public class CompositeMetaData<I, M> implements Iterable<Entry<I, M>>, Cloneable {
	...
	/**
	 * A reference to the read lock of the internally used reentrant read/write
	 * lock.
	 */
	protected final Lock readLock = lock.readLock();
	
	/**
	 * A reference to the write lock of the internally used reentrant
	 * read/write lock.
	 */
