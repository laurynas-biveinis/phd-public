...
public class MergeSorter<E> extends AbstractCursor<E> {
	...
	public MergeSorter(
		...
		this(
			...
			newQueue,
			new Function<Object, Queue<Cursor<E>>>() {
	...
	public MergeSorter(
		...
		this(
			...
			memSize,
			finalMemSize,
			new Function<Function<?, Integer>, Queue<E>>() {
	...
	public void open() {
		...
		Println<Object> print = Println.DEFAULT_INSTANCE;
		...
		Queue<Cursor<E>> queues = newQueuesQueue.invoke(
			new Mapper<Iterator<E>, Cursor<E>>(
				...
				new Function<Iterator<E>, Cursor<E>>() {
