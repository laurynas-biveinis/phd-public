 ...
 *						new Predicate() { // and checking if the given point is contained in the search sphere
...
public class DBScan extends AbstractCursor {
	...
	public static void main(String[] args) {
		...
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 1.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 1.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{3.0, 1.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 2.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 2.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 2.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 2.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 2.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{3.0, 2.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{3.0, 2.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 8.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 3.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 3.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{3.0, 3.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{4.0, 4.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{5.0, 5.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{6.0, 6.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{7.0, 7.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{8.0, 8.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{9.0, 9.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 6.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 7.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 8.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 9.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 7.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 7.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 7.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 7.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 7.0})));
		...
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 8.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{2.0, 9.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{3.0, 9.0})));

		data.insert(new ClassifiableObject(new DoublePoint(new double[]{5.0, 9.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{9.0, 4.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{8.0, 1.0})));

		/*
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{4.0, 4.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{0.0, 0.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 1.0})));
		data.insert(new ClassifiableObject(new DoublePoint(new double[]{1.0, 1.0})));
