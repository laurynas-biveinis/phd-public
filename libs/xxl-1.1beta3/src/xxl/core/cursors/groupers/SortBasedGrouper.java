...
public class SortBasedGrouper<E> extends AbstractCursor<Cursor<E>> {
	 ...
	 * to yield proper results. Multiple calls to <tcodet>close</code> do not
	 ...
	 * exception.) This happens when the specified predicate evalutated for the
	...
	public static void main(String[] args) {
		...
		SortBasedGrouper<Integer> sortBasedGrouper = new SortBasedGrouper<Integer>(
			...
			new Predicate<Integer>() {// the predicate used for comparison
				public boolean invoke(Integer previous, Integer next) {
					return previous > next;
				}
			}
