 ...
 * {@link xxl.core.functions.Tuplify#IDENTITY identity} function delivers the
...
public class SortMergeEquivalenceJoin<I, E> extends SortMergeJoin<I, E> {
	 ...
	 * @throws IllegalArgumentException if the specified type is not valid.
	 */
	public SortMergeEquivalenceJoin(Iterator<? extends I> sortedInput0, Iterator<? extends I> sortedInput1, Function<?, ? extends SweepArea<I>> newSweepArea, Comparator<? super I> comparator, Function<? super I, ? extends E> newResult, Type type) throws IllegalArgumentException {
