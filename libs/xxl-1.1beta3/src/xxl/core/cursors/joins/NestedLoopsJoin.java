 ...
 *         Therfore the predicate is evaluated for a tuple built of one element
 ...
 *         method modelling the resulting object (tuple). Be aware that this
 ...
 * method returning an itertion containing the even elements are created. The
...
public class NestedLoopsJoin<I, E> extends AbstractCursor<E> {
	 ...
	 * Therfore the predicate is evaluated for a tuple built of one element of
