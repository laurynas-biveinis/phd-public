 ...
 * @param <M> the type of the mata data provided by this predicate.
 * @see DecoratorPredicate
 * @see MetaDataProvider
 * @see Predicate
 */
public abstract class MetaDataPredicate<P, M> extends DecoratorPredicate<P> implements MetaDataProvider<M> {
	 ...
	 */
	public MetaDataPredicate(Predicate<? super P> predicate) {
		super(predicate);
	}

	/**
	 * Returns the meta data for this meta data predicate. Concrete
	 * implementations of this class must implement this method for meta data
	 * access.
	 *
