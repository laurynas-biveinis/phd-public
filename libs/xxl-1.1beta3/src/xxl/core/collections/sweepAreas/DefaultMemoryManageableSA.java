 ...
 */
public class DefaultMemoryManageableSA<E> extends MemoryManageableSA<E> {

    public static <E> Function<SweepArea<E>,DefaultMemoryManageableSA<E>> getMemoryManageableSA(final SweepArea<E> sweepArea, final int objectSize, final int preferredMemSize) {
		return new Function<SweepArea<E>,DefaultMemoryManageableSA<E>>() {		
			public DefaultMemoryManageableSA<E> invoke() {
				return new DefaultMemoryManageableSA<E>(sweepArea, objectSize, preferredMemSize);
			}
		};
	}
    
    public static <E> DefaultMemoryManageableSA wrapSweepArea(SweepArea<E> sweepArea, final int objectSize, final int preferredMemSize) {
    	return new DefaultMemoryManageableSA<E>(sweepArea, objectSize, preferredMemSize);
    }
	 ...
	 * <code>p/q</code>.
	 */
	public static class EveryQth<E> extends Predicate<E> {
	 ...
	 */
	public DefaultMemoryManageableSA(SweepArea<E> sweepArea, int objectSize, int memSize) {
