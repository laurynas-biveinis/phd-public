 ...
 * 
 */
public class DecoratorSweepArea<E> extends AbstractSweepArea<E> {

	/**
	 * The underlying sweeparea. 
	 */
	protected final SweepArea<E> sweepArea;	

	public DecoratorSweepArea(SweepArea<E> sweepArea, int objectSize) {
		super(objectSize);
		this.sweepArea = sweepArea;
	}

	public DecoratorSweepArea(SweepArea<E> sweepArea) {
	...
	public SweepArea<E> getSweepArea() {
		return sweepArea;
	}
