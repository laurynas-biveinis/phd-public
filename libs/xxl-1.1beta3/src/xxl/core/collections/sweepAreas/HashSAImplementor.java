...
public class HashSAImplementor<E> extends AbstractSAImplementor<E> {
	 ...
	 * 
	 */
	public HashSAImplementor(Function<? super E,Integer>[] hashFunctions, Function<?,List<E>> newList, Predicate<? super E> equals) {
		super(equals);
	...
	public HashSAImplementor(Function<? super E,Integer>[] hashFunctions) {
		this.hashFunctions = hashFunctions;
		this.hashTable = new HashMap<Integer, List<E>>();
		this.newList = new Function<Object,List<E>>() {
	 ...
	 * 		  of {@link Equal equal} predicate. 
	 */
	public HashSAImplementor(Function<? super E,Integer> hashFunction, Function<?,List<E>> newList, int dim, Predicate<? super E> equals) {
		super(equals);
		this.hashTable = new HashMap<Integer, List<E>>();
		this.newList = newList;
	...
	public Iterator<E> iterator() {
		return new Sequentializer<E>(
			new Mapper<List<E>, Iterator<E>>(
				new Function() {
					public Object invoke(Object bucket) {
						return ((List<E>)bucket).iterator();
					}
				},
