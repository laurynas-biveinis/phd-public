...
public class Heap<E> extends AbstractQueue<E> {
	 ...
	 */
	private static void testIntegerHeapOutput(Heap<Integer> heap, boolean output) {
		int lastValue=-1;
		while(!heap.isEmpty()) {
	...
	public static void main(String[] args) {
		...
		//                      Usage example (4).                      //
		//////////////////////////////////////////////////////////////////
		Heap<Integer> heap2 = new Heap<Integer>(1000, ComparableComparator.INTEGER_COMPARATOR);
		...
		heap2 = new Heap<Integer>(1000, ComparableComparator.INTEGER_COMPARATOR);
