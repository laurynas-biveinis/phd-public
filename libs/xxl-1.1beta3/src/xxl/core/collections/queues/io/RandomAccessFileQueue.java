...
public class RandomAccessFileQueue<E> extends StreamQueue<E> implements FIFOQueue<E> {
	 ...
	 * @see Function
	 */
	public static final Function<Object, RandomAccessFileQueue<Convertable>> FACTORY_METHOD = new Function<Object, RandomAccessFileQueue<Convertable>>() {
	 ...
	 */
	public class InputStreamFactory extends Function<Object, InputStream> {
		/**
	 ...
	 */
	public class OutputStreamFactory extends Function<Object, OutputStream> {
		/**
		 * Returns the result of the function as an object. Note that the
		 * caller has to cast the result to the desired class.
		 * @return the function value is returned.
