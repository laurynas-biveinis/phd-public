...
public class CounterContainer extends ConstrainedDecoratorContainer {
	 ...
	 * @see Function
	 */
	public static final Function<Container,CounterContainer> FACTORY_METHOD = new Function<Container,CounterContainer>() {
	...
	*/
	...
	public static void main (String [] args) {
		...
		// insert 20 elements and print the counters
		for (int i = 0; i < 20; i++)
			container.insert(Integer.valueOf(i));
		System.out.println(container);
		System.out.println();
		...
		for (int i = 0; i < 5; i++)
			if (iterator.hasNext())
				container.update(iterator.next(), Integer.valueOf(i));
		System.out.println(container);
		System.out.println();
