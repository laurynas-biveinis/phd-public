 ...
 * 
 * Copyright (C) 2000-2006 Prof. Dr. Bernhard Seeger Head of the Database
	...
	public static void main(String[] args) {
		...
		final Function newQueue = new Function() {
			...
			public Object invoke(Object inputBufferSize,
				...
				if (external) {
					...
					return new RandomAccessFileQueue(file, xxl.core.io.converters.ConvertableConverter.DEFAULT_INSTANCE, new Function() {
		...
		Function newSorter = new Function() {
			public Object invoke(Object object) {
				return new MergeSorter((Iterator) object, new ComparableComparator(), objectSize, mem,
