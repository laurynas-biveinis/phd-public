...
public class Maths {
	...
	public static void main(String[] args) {
		...
		System.out.println("Solved=" + java.util.Arrays.toString(triDiagonalGaussianLGS(a1, a2, a3, a4)));
		...
		final double m = 2.0;
		final double b = 8.0;
		Function<Number, Double> f1 = new Function<Number, Double>() {
		...
		System.out.println(java.util.Arrays.toString(rootFinding(a5, b5, h5, f)));
		System.out.println("-----------------------------------------\n");
