...
public class NumericalAggregateND extends AggregationFunction<double[],double[]> {
	...
	public static AggregationFunction VARIANCE_ND = new NumericalAggregateND(new Function() {
	...
	public static AggregationFunction STANDARDDEVIATION_ND = new NumericalAggregateND(new Function() {
		public Object invoke() {
	...
	public static AggregationFunction AVERAGE_ND = new NumericalAggregateND(new Function() {
		public Object invoke() {
			return new Average();
		}
	});
	...
	public static AggregationFunction MINIMUM_ND = new NumericalAggregateND(new Function() {
		public Object invoke() {
			return new Minimum();
		}
	});
	...
	public static AggregationFunction MAXIMUM_ND = new NumericalAggregateND(new Function() {
		public Object invoke() {
			return new Maximum();
		}
	});
	...
	public static AggregationFunction SUM_ND = new NumericalAggregateND(new Function() {
		public Object invoke() {
			return new Sum();
		}
	});
	...
	public static AggregationFunction COUNT_ND = new NumericalAggregateND(new Function() {
		public Object invoke() {
			return new Count();
		}
	});
