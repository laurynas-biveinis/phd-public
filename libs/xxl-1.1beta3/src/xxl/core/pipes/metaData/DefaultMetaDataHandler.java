...
public class DefaultMetaDataHandler<M> extends AbstractMetaDataHandler<M> {
	
	protected Function<?,? extends M> function;
	
	public DefaultMetaDataHandler(AbstractNodeMetaDataManagement mdm, Object metaDataIdentifier, Function<?,? extends M> function) {
