...
/**
 * A <code>Processor</code> that has to be scheduled with high priority by a <code>Scheduler</code>.
 * That means, that such a processor is not allowed to be blocked over a longer time by the scheduler.
 * Processors for sources will usually be of this kind {@link SourceProcessor}.
 *
 ...
 * @since 1.1
 */
public abstract class UrgentProcessor extends Processor {
	 ...
	 * @param sleep
	 */
	public UrgentProcessor(Iterator<Long> delayManager, Timer timer, boolean sleep) {
	 ...
	 * 		two successive <CODE>process</CODE> calls (in milliseconds).
	 */
	public UrgentProcessor(Iterator<Long> delayManager) {
		super(delayManager);
	}
	
	/**
	 * Creates a new urgent processor. If a scheduler is set, this processor will
	 ...
	 */
	public UrgentProcessor(long period) {
		super(period);
		if (scheduler != null) {
	 ...
	 * by calling <code>Scheduler.reportStart(UrgentProcessor)</code>.
	 *
	 * @see xxl.core.pipes.scheduler.Scheduler
	 */
	@Override
	 ...
	 * by calling <code>Scheduler.reportBlocked(UrgentProcessor)</code>.
	 *
	 * @see xxl.core.pipes.scheduler.Scheduler
	 */
	@Override
	 ...
	 * by calling <code>Scheduler.reportBlocked(UrgentProcessor, long)</code>.
	 *
	 ...
	 * by calling <code>Scheduler.reportUnblocked(UrgentProcessor)</code>.
	 *
	 * @see xxl.core.pipes.scheduler.Scheduler
	 */
	@Override
	 ...
	 * by calling <code>Scheduler.reportTermination(UrgentProcessor)</code>.
	 *
	 * @see xxl.core.pipes.scheduler.Scheduler
	 */
	@Override
	 ...
	 * by calling <code>Scheduler.reportPriorityChange(UrgentProcessor)</code>.
	 *
	 * @see xxl.core.pipes.scheduler.Scheduler
	 */
	@Override
