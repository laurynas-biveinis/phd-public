...
rem package name
set native_package=xxl.core.util.timers

rem path source
set native_java_path=xxl\core\util\timers\
set native_c_path=xxl\connectivity\jni\timer\

rem name the jni-class
set native_class=JNITimer

rem name of the library (dll-file without extension)
set native_dll=JNITimer
