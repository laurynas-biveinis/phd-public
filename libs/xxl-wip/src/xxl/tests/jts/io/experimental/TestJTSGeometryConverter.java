...
import xxl.connectivity.jts.io.experimental.JTSGeometryConverter;
import xxl.core.spatial.geometries.Geometry2D;

/**
 * Some examples to demonstrate the functionality and the usage
 * of the class JTSGeometryConverter.
 */
public class TestJTSGeometryConverter {

	
	/** USE CASE: The main method contains some examples how to use this geometry converter. It
	...
	public static void main(String[] args) throws IOException{
		...
		JTSGeometryConverter.DEFAULT_INSTANCE.write( new java.io.DataOutputStream( output ), geometry0);
		
		// create a byte array input stream on the output stream
		java.io.ByteArrayInputStream input = new java.io.ByteArrayInputStream(output.toByteArray());
		
		// read a Geometry from the input stream
		Geometry2D geometry1 = JTSGeometryConverter.DEFAULT_INSTANCE.read( new java.io.DataInputStream( input ));
