...
import xxl.connectivity.jts.io.experimental.SerializableGeometryConverter;

/**
 * Some examples to demonstrate the functionality and the usage
 * of the class SerializableGeometryConverter.
 */
public class TestSerializableGeometryConverter {
