...
import xxl.core.math.statistics.parametric.aggregates.ThirdCentralMomentEstimator;
import xxl.core.util.random.JavaDiscreteRandomWrapper;

/**
 * Some examples to demonstrate the functionality and the usage
 * of the class ThirdCentralMomentEstimator.
 */
public class TestThirdCentralMomentEstimator {
