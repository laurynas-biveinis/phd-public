...
import xxl.core.math.statistics.nonparametric.kernels.HybridKernelBasedBlockEstimatorAggregationFunction;
import xxl.core.util.random.JavaContinuousRandomWrapper;

/**
 * Some examples to demonstrate the functionality and the usage
 * of the class HybridKernelBasedBlockEstimatorAggregationFunction.
 */
public class TestHybridKernelBasedBlockEstimatorAggregationFunction {
	...
	public static void main(String[] args) {
		...
		Aggregator aggregator = 
			new Aggregator(
				HybridKernelBasedBlockEstimatorAggregationFunction.inputCursor(
					cursor, 
					blockSize, 
