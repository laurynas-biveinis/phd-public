...
public class ListSA<E> extends ImplementorBasedSweepArea<E> {
	 ...
	 */
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, ReorganizeModes reorganizeMode, Predicate<? super E>[] queryPredicates, Predicate<? super E>[] removePredicates, List<E> list, int objectSize) {
		super(impl, ID, selfReorganize, queryPredicates, removePredicates, objectSize);
		this.reorganizeMode = reorganizeMode;
		this.list = list;
	}	

	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, ReorganizeModes reorganizeMode, Predicate<? super E>[] queryPredicates, Predicate<? super E>[] removePredicates, Predicate<? super E> equals, List<E> list, int objectSize) {		
	 ...
	 * @param objectSize The object size of the elements in the sweeparea. 
	 */
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E>[] queryPredicates, Predicate<? super E>[] removePredicates, List<E> list, int objectSize) {		
		this (impl, ID, selfReorganize, ReorganizeModes.LAZY_REORGANIZE, queryPredicates, removePredicates, list, objectSize);
	}
	
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E>[] queryPredicates, Predicate<? super E>[] removePredicates, Predicate<? super E> equals, List<E> list, int objectSize) {		
		this (impl, ID, selfReorganize, ReorganizeModes.LAZY_REORGANIZE, queryPredicates, removePredicates, equals, list, objectSize);
	}
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E>[] queryPredicates, Predicate<? super E> removePredicate, Predicate<? super E> equals, List<E> list, int objectSize) {
		super(impl, ID, selfReorganize, queryPredicates, removePredicate, equals, objectSize);
		this.list = list;
		this.reorganizeMode = ReorganizeModes.LAZY_REORGANIZE;
	}		
	 ...
	 * @param objectSize The object size of the elements in the sweeparea.
	 */
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, ReorganizeModes reorganizeMode, Predicate<? super E> queryPredicate, Predicate<? super E> removePredicate, int dim, List<E> list, int objectSize) {
		super(impl, ID, selfReorganize, queryPredicate, removePredicate, dim, objectSize);
		this.list = list;
		this.reorganizeMode = reorganizeMode;
	}

	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, ReorganizeModes reorganizeMode, Predicate<? super E> queryPredicate, Predicate<? super E> removePredicate, Predicate<? super E> equals, int dim, List<E> list, int objectSize) {
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E> queryPredicate, Predicate<? super E> removePredicate, Predicate<? super E> equals, int dim, List<E> list) {
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E>[] queryPredicates, Predicate<? super E>[] removePredicates) {
		this(impl, ID, selfReorganize, queryPredicates, removePredicates, new LinkedList<E>());
	}
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E>[] queryPredicates, Predicate<? super E> removePredicate) {
		this(impl, ID, selfReorganize, queryPredicates, removePredicate, new LinkedList<E>());
	}
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E>[] queryPredicates) {
		this(impl, ID, selfReorganize, queryPredicates, new LinkedList<E>());
	}
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E> queryPredicate, Predicate<? super E> removePredicate, int dim) {
		this(impl, ID, selfReorganize, queryPredicate, removePredicate, dim, new LinkedList<E>());
	}
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, boolean selfReorganize, Predicate<? super E> queryPredicate, int dim) {
		this(impl, ID, selfReorganize, queryPredicate, dim, new LinkedList<E>());
	}
	...
	public ListSA(SweepAreaImplementor<E> impl, int ID, int dim) {
		this(impl, ID, dim, new LinkedList<E>());
	}
